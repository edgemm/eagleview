...
<body<?php if (is_home()) echo(' id="home"'); ?> <?php body_class(); ?>>
	<div id="container">
		<div id="header">
        <div id="bbb-logo"><a href="http://www.bbb.org/southern-colorado/business-reviews/mortgage-brokers/eagle-view-mortgage-in-colorado-city-co-87331349" target="_blank" rel="nofollow"><img src="/wp-content/themes/eagleview-child/images/BBB-A+Rating.png" /></a></div>
            <span class="logolink">
